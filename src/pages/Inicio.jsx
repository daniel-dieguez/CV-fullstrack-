  ...
  return (
    <div className={style.cuerpoproyecto}>
     <div className={style.titulos}> 
      <h1 className={style.titulo}>Desarrollador Fullstrack</h1>
      <h3>Un ambiente de desarrollo profecional </h3>
      <h4 className={style.nombre}>Daniel Dieguez</h4>
      </div>

      <img  className={style.fotopergil} src={fotoperfil} alt="" srcset="" />

      <p className={style.textocuerpo}>En este proyecto, destaco la importancia de tener metas y objetivos claros como piedra 
